...
/* This function will be called when we read the value file */
static ssize_t value_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
    pr_info("value read.....\n");
    return 0;
...
/* This function will be called when we write the value file */
static ssize_t value_store(struct kobject *kobj, struct kobj_attribute *attr,const char *buf, size_t count)
{
    pr_info("value write.....\n");
    return count;
...
/* This function will be called when we read the direction file */
static ssize_t direction_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
...
/* This function will be called when we write the direction file */
static ssize_t direction_store(struct kobject *kobj, struct kobj_attribute *attr,const char *buf, size_t count)
{
